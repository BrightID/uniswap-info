...
function parseData(data, oneDayData, twoDayData, oneWeekData, ethPrice, oneDayBlock) {
  ...
  if (data?.token0?.id === '0x2b309226500ADc5956a422950A2AD6E6333Bb315') {
    data.token0.name = 'EIDI (Wrapped)'
    data.token0.symbol = 'WEIDI'
  }
  if (data?.token1?.id === '0x2b309226500ADc5956a422950A2AD6E6333Bb315') {
    data.token1.name = 'EIDI (Wrapped)'
    data.token1.symbol = 'WEIDI'
  }
