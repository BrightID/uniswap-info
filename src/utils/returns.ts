...
export const priceOverrides = [
  '0x128741612e7575aea3f6e94cb567c75c4c415d89', // DAI
]
...
function formatPricesForEarlyTimestamps(position): Position {
  if (position.timestamp < PRICE_DISCOVERY_START_TIMESTAMP) {
    ...
    // WETH price
    if (position.pair?.token0.id === '0x2b309226500ADc5956a422950A2AD6E6333Bb315') {
      position.token0PriceUSD = 203
    }
    if (position.pair?.token1.id === '0x2b309226500ADc5956a422950A2AD6E6333Bb315') {
